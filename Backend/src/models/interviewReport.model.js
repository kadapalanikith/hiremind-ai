...
const interviewReportSchema = new mongoose.Schema({
    ...
    // Renamed to skillGaps to match what AI returns as skillGapAnalysis spread
    skillGaps: [skillGapSchema],
    preparationPlan: [preparationPlanSchema],
    user: {
        type: mongoose.Schema.Types.ObjectId,
        ref: "User", // Fixed: was "users", must match mongoose.model("User", ...)
        required: true,
...
// Compound index for common query pattern: user's reports sorted by date
